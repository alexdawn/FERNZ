...
industry.economy_variations['FERNZ'].accept_cargo_types = ['FOOD', 'FRUT', 'COAL']
industry.economy_variations['FERNZ'].prod_cargo_types = ['AORE', 'RFPR']
industry.economy_variations['FERNZ'].prod_multiplier = '[16, 16]'
industry.economy_variations['FERNZ'].prob_random = '3'
