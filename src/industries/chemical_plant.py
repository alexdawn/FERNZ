...
industry.economy_variations['FERNZ'].processed_cargos_and_output_ratios = [('SALT', 8)]
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'chemical_plant_tile_2', 'chemical_plant_spritelayout_fat_chimney'),
            ...
            (1, 4, 'chemical_plant_tile_1', 'chemical_plant_spritelayout_drop_tower_and_thin_chimney'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'chemical_plant_tile_2', 'chemical_plant_spritelayout_fat_chimney'),
            ...
            (1, 2, 'chemical_plant_tile_1', 'chemical_plant_spritelayout_drop_tower_and_thin_chimney'),
