...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'ammonia_plant_tile_1', 'ammonia_plant_spritelayout_1'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 1, 'ammonia_plant_tile_1', 'ammonia_plant_spritelayout_4'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'ammonia_plant_tile_1', 'ammonia_plant_spritelayout_4'),
