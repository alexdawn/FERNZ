# -*- coding: utf-8 -*-
__filename = 'C:\\Users\\Alex\\Documents\\fernz\\src\\templates\\animation_macros.pynml'
...
_static_2075083911968 = "tile.animation_macros()[tile.custom_animation_control['macro']]"
...
def initialize(__loader, macros, nothing, template):
    ...
    def render_tile_animation(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            get = econtext.get
            __append('\n    ')
            __backup_tile_2075099296096 = get('tile', __marker)

            # <Value 'industry.tiles' (4:28)> -> __iterator
            __token = 157
            __iterator = _lookup_attr(getitem('industry'), 'tiles')
            (__iterator, ____index_2075083911856, ) = getitem('repeat')('tile', __iterator)
            econtext['tile'] = None
            for __item in __iterator:
                ...
                if __condition:
                    __backup_macroname_2075100178056 = get('macroname', __marker)

                    # <Static value=<_ast.Str object at 0x000001E324A3B320> name=None at 1e325a440b8> -> __value
                    __value = _static_2075083911968
                    ...
                    if (__backup_macroname_2075100178056 is __marker):
                        del econtext['macroname']
                    else:
                        econtext['macroname'] = __backup_macroname_2075100178056
                __append('\n    ')
                ____index_2075083911856 -= 1
                if (____index_2075083911856 > 0):
                    __append('')
            if (__backup_tile_2075099296096 is __marker):
                del econtext['tile']
            else:
                econtext['tile'] = __backup_tile_2075099296096
            __append('\n')
        except:
    ...
    def render_random_first_frame(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __token = 1631
            __content_2075086945112_1629 = _lookup_attr(getitem('tile'), 'animation_length')
            __content_2075086945112_1629 = __quote(__content_2075086945112_1629, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), '_anim_control, (extra_callback_info1 % ', (__content_2075086945112_1629 if (__content_2075086945112_1629 is not None) else ''), ')) {\n        ', ))
            ...
            __backup_frame_2075099277968 = get('frame', __marker)

            # <Value 'range(tile.animation_length)' (32:34)> -> __iterator
            __token = 1692
            __iterator = get('range', range)(_lookup_attr(getitem('tile'), 'animation_length'))
            (__iterator, ____index_2075100726496, ) = getitem('repeat')('frame', __iterator)
            econtext['frame'] = None
            for __item in __iterator:
                econtext['frame'] = __item

                # <Interpolation value=<Substitution '\n            ${repeat.frame.index}: return ${repeat.frame.index};\n        ' (32:64)> braces_required=True translation=False at 1e325a444a8> -> __content_2075086945112
                __token = 1735
                __token = 1737
                __content_2075086945112 = _lookup_attr(_lookup_attr(getitem('repeat'), 'frame'), 'index')
                __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
                __token = 1767
                __content_2075086945112_1765 = _lookup_attr(_lookup_attr(getitem('repeat'), 'frame'), 'index')
                __content_2075086945112_1765 = __quote(__content_2075086945112_1765, '\x00', '&#0;', None, False)
                __content_2075086945112 = ('%s%s%s%s%s' % ('\n            ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ': return ', (__content_2075086945112_1765 if (__content_2075086945112_1765 is not None) else ''), ';\n        ', ))
                if (__content_2075086945112 is None):
                    pass
                else:
                    if (__content_2075086945112 is False):
                ...
                if (__content_2075086945112 is not None):
                    __append(__content_2075086945112)
                ____index_2075100726496 -= 1
                if (____index_2075100726496 > 0):
                    __append('')
            if (__backup_frame_2075099277968 is __marker):
                del econtext['frame']
            else:
                econtext['frame'] = __backup_frame_2075099277968
            __append('\n        return CB_RESULT_NEXT_FRAME;\n    }\n')
        except:
            if (__token is not None):
                rcontext.setdefault('__error__', []).append((__tokens[__token] + (__filename, _exc_info()[1], )))
    ...
    def render_first_frame_is_0(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${tile.id}_anim_control, 0) {\n        return 0;\n    }\n' (41:90)> braces_required=True translation=False at 1e325a44b00> -> __content_2075086945112
            __token = 2041
            __token = 2076
            __content_2075086945112 = _lookup_attr(getitem('tile'), 'id')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), '_anim_control, 0) {\n        return 0;\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_oil_wells(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution "\n    switch (FEAT_INDUSTRYTILES, SELF, ${tile.id}_stop_anim, animation_frame) {\n        1: return 11; // jump to the 'stop animation cycle' when triggered and currently animated\n        2: return 12;\n        3: return 13;\n        4: return 14;\n        5: return 15;\n        6: return 16;\n        7: return 17;\n        8: return 18;\n        9: return 19;\n        10: return 20;\n        return CB_RESULT_DO_NOTHING;\n    }\n\n    switch (FEAT_INDUSTRYTILES, SELF, ${tile.id}_start_anim, animation_frame) {\n        11: return 1;\n        12: return 2;\n        13: return 3;\n        14: return 4;\n        15: return 5;\n        16: return 6;\n        17: return 7;\n        18: return 8;\n        19: return 9;\n        20: return 10;\n        return CB_RESULT_START_ANIMATION;\n    }\n\n    random_switch (FEAT_INDUSTRYTILES, SELF, ${tile.id}_anim_control, bitmask(TRIGGER_INDUSTRYTILE_TILELOOP)) {\n        1: return ${tile.id}_stop_anim;\n        1: return ${tile.id}_start_anim;\n    }\n\n    switch (FEAT_INDUSTRYTILES, SELF, ${tile.custom_animation_next_frame}, animation_frame) {\n        10: return 1;\n        11: return CB_RESULT_STOP_ANIMATION; // Don't actually stop animation, just keep looping the same frame over and over.\n        20: return 11;\n        return CB_RESULT_NEXT_FRAME;\n    }\n" (48:74)> braces_required=True translation=False at 1e325a44e10> -> __content_2075086945112
            __token = 2283
            __token = 2319
            __content_2075086945112 = _lookup_attr(getitem('tile'), 'id')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 2739
            __content_2075086945112_2737 = _lookup_attr(getitem('tile'), 'id')
            __content_2075086945112_2737 = __quote(__content_2075086945112_2737, '\x00', '&#0;', None, False)
            __token = 3096
            __content_2075086945112_3094 = _lookup_attr(getitem('tile'), 'id')
            __content_2075086945112_3094 = __quote(__content_2075086945112_3094, '\x00', '&#0;', None, False)
            __token = 3181
            __content_2075086945112_3179 = _lookup_attr(getitem('tile'), 'id')
            __content_2075086945112_3179 = __quote(__content_2075086945112_3179, '\x00', '&#0;', None, False)
            __token = 3221
            __content_2075086945112_3219 = _lookup_attr(getitem('tile'), 'id')
            __content_2075086945112_3219 = __quote(__content_2075086945112_3219, '\x00', '&#0;', None, False)
            __token = 3289
            __content_2075086945112_3287 = _lookup_attr(getitem('tile'), 'custom_animation_next_frame')
            __content_2075086945112_3287 = __quote(__content_2075086945112_3287, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s%s%s%s%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), "_stop_anim, animation_frame) {\n        1: return 11; // jump to the 'stop animation cycle' when triggered and currently animated\n        2: return 12;\n        3: return 13;\n        4: return 14;\n        5: return 15;\n        6: return 16;\n        7: return 17;\n        8: return 18;\n        9: return 19;\n        10: return 20;\n        return CB_RESULT_DO_NOTHING;\n    }\n\n    switch (FEAT_INDUSTRYTILES, SELF, ", (__content_2075086945112_2737 if (__content_2075086945112_2737 is not None) else ''), '_start_anim, animation_frame) {\n        11: return 1;\n        12: return 2;\n        13: return 3;\n        14: return 4;\n        15: return 5;\n        16: return 6;\n        17: return 7;\n        18: return 8;\n        19: return 9;\n        20: return 10;\n        return CB_RESULT_START_ANIMATION;\n    }\n\n    random_switch (FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112_3094 if (__content_2075086945112_3094 is not None) else ''), '_anim_control, bitmask(TRIGGER_INDUSTRYTILE_TILELOOP)) {\n        1: return ', (__content_2075086945112_3179 if (__content_2075086945112_3179 is not None) else ''), '_stop_anim;\n        1: return ', (__content_2075086945112_3219 if (__content_2075086945112_3219 is not None) else ''), '_start_anim;\n    }\n\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112_3287 if (__content_2075086945112_3287 is not None) else ''), ", animation_frame) {\n        10: return 1;\n        11: return CB_RESULT_STOP_ANIMATION; // Don't actually stop animation, just keep looping the same frame over and over.\n        20: return 11;\n        return CB_RESULT_NEXT_FRAME;\n    }\n", ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
