# -*- coding: utf-8 -*-
__filename = 'C:\\Users\\Alex\\Documents\\fernz\\src\\templates\\location_check_macros_tile.pynml'
...
_static_2075099681232 = 'location_check.macro'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render_render_tree(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            get = econtext.get
            __append('\n    ')
            __backup_tile_2075099276232 = get('tile', __marker)

            # <Value 'industry.tiles' (9:43)> -> __iterator
            __token = 389
            __iterator = _lookup_attr(getitem('industry'), 'tiles')
            (__iterator, ____index_2075099682072, ) = getitem('repeat')('tile', __iterator)
            econtext['tile'] = None
            for __item in __iterator:
                econtext['tile'] = __item
                __append('\n        ')
                __backup_location_checks_2075099755520 = get('location_checks', __marker)
                ...
                __backup_location_check_2075099757312 = get('location_check', __marker)

                # <Value 'location_checks' (10:125)> -> __iterator
                __token = 531
                __iterator = getitem('location_checks')
                (__iterator, ____index_2075099682856, ) = getitem('repeat')('location_check', __iterator)
                econtext['location_check'] = None
                for __item in __iterator:
                    econtext['location_check'] = __item
                    __append('\n            ')
                    __backup_macroname_2075100640200 = get('macroname', __marker)

                    # <Static value=<_ast.Str object at 0x000001E3259451D0> name=None at 1e3259453c8> -> __value
                    __value = _static_2075099681232
                    ...
                    if (__backup_macroname_2075100640200 is __marker):
                        del econtext['macroname']
                    else:
                        econtext['macroname'] = __backup_macroname_2075100640200
                    __append('\n        ')
                    ____index_2075099682856 -= 1
                    if (____index_2075099682856 > 0):
                        __append('')
                if (__backup_location_check_2075099757312 is __marker):
                    del econtext['location_check']
                else:
                    econtext['location_check'] = __backup_location_check_2075099757312
                if (__backup_location_checks_2075099755520 is __marker):
                    del econtext['location_checks']
                else:
                    econtext['location_checks'] = __backup_location_checks_2075099755520
                __append('\n    ')
                ____index_2075099682072 -= 1
                if (____index_2075099682072 > 0):
                    __append('')
            if (__backup_tile_2075099276232 is __marker):
                del econtext['tile']
            else:
                econtext['tile'] = __backup_tile_2075099276232
            __append('\n')
        except:
    ...
    def render_require_sea_tile(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __token = 1139
            __content_2075086945112_1137 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_1137 = __quote(__content_2075086945112_1137, '\x00', '&#0;', None, False)
            __token = 1198
            __content_2075086945112_1196 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_1196 = __quote(__content_2075086945112_1196, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ', nearby_tile_water_class(0,0)) {\n        WATER_CLASS_SEA: ', (__content_2075086945112_1137 if (__content_2075086945112_1137 is not None) else ''), ';\n        WATER_CLASS_NONE: ', (__content_2075086945112_1196 if (__content_2075086945112_1196 is not None) else ''), ';\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n', ))
    ...
    def render_require_height_range(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, UCMP(nearby_tile_height(0, 0) - ${location_check.minh}, ${location_check.maxh} - ${location_check.minh})) {\n        0..1: ${location_check.switch_result};\n        ${location_check.outrange};\n    }\n' (32:114)> braces_required=True translation=False at 1e325945c18> -> __content_2075086945112
            __token = 1631
            __token = 1666
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 1736
            __content_2075086945112_1734 = _lookup_attr(getitem('location_check'), 'minh')
            __content_2075086945112_1734 = __quote(__content_2075086945112_1734, '\x00', '&#0;', None, False)
            __token = 1760
            __content_2075086945112_1758 = _lookup_attr(getitem('location_check'), 'maxh')
            __content_2075086945112_1758 = __quote(__content_2075086945112_1758, '\x00', '&#0;', None, False)
            __token = 1785
            __content_2075086945112_1783 = _lookup_attr(getitem('location_check'), 'minh')
            __content_2075086945112_1783 = __quote(__content_2075086945112_1783, '\x00', '&#0;', None, False)
            __token = 1826
            __content_2075086945112_1824 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_1824 = __quote(__content_2075086945112_1824, '\x00', '&#0;', None, False)
            __token = 1867
            __content_2075086945112_1865 = _lookup_attr(getitem('location_check'), 'outrange')
            __content_2075086945112_1865 = __quote(__content_2075086945112_1865, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s%s%s%s%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ', UCMP(nearby_tile_height(0, 0) - ', (__content_2075086945112_1734 if (__content_2075086945112_1734 is not None) else ''), ', ', (__content_2075086945112_1758 if (__content_2075086945112_1758 is not None) else ''), ' - ', (__content_2075086945112_1783 if (__content_2075086945112_1783 is not None) else ''), ')) {\n        0..1: ', (__content_2075086945112_1824 if (__content_2075086945112_1824 is not None) else ''), ';\n        ', (__content_2075086945112_1865 if (__content_2075086945112_1865 is not None) else ''), ';\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_disallow_coast_or_water(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_is_water(0, 0)) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ${location_check.switch_result};\n    }\n' (41:70)> braces_required=True translation=False at 1e3259457f0> -> __content_2075086945112
            __token = 2083
            __token = 2118
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 2241
            __content_2075086945112_2239 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_2239 = __quote(__content_2075086945112_2239, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ', nearby_tile_is_water(0, 0)) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ', (__content_2075086945112_2239 if (__content_2075086945112_2239 is not None) else ''), ';\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_disallow_steep_slopes(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_slope(0,0) & bitmask(IS_STEEP_SLOPE)) {\n        0: ${location_check.switch_result};\n        return string(STR_ERR_LOCATION_NOT_ON_STEEP_SLOPE);\n    }\n' (50:94)> braces_required=True translation=False at 1e3258dabe0> -> __content_2075086945112
            __token = 2485
            __token = 2521
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 2622
            __content_2075086945112_2620 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_2620 = __quote(__content_2075086945112_2620, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ', nearby_tile_slope(0,0) & bitmask(IS_STEEP_SLOPE)) {\n        0: ', (__content_2075086945112_2620 if (__content_2075086945112_2620 is not None) else ''), ';\n        return string(STR_ERR_LOCATION_NOT_ON_STEEP_SLOPE);\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_disallow_slopes(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_slope(0,0) == SLOPE_FLAT) {\n        1: ${location_check.switch_result};\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n' (59:91)> braces_required=True translation=False at 1e3258dae80> -> __content_2075086945112
            __token = 2909
            __token = 2945
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 3034
            __content_2075086945112_3032 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_3032 = __quote(__content_2075086945112_3032, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ', nearby_tile_slope(0,0) == SLOPE_FLAT) {\n        1: ', (__content_2075086945112_3032 if (__content_2075086945112_3032 is not None) else ''), ';\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_require_slope(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_slope(0,0) == SLOPE_FLAT) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ${location_check.switch_result};\n    }\n\n' (68:123)> braces_required=True translation=False at 1e3258daf28> -> __content_2075086945112
            __token = 3327
            __token = 3362
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 3495
            __content_2075086945112_3493 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_3493 = __quote(__content_2075086945112_3493, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ', nearby_tile_slope(0,0) == SLOPE_FLAT) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ', (__content_2075086945112_3493 if (__content_2075086945112_3493 is not None) else ''), ';\n    }\n\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_require_road_adjacent(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point},\n                                                      (\n                                                      nearby_tile_class(0, -1) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(0, 1) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(-1, 0) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(1, 0) == TILE_CLASS_ROAD ? 1 : 0\n                                                      ))))) {\n        1: ${location_check.switch_result};\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n' (78:84)> braces_required=True translation=False at 1e3258da978> -> __content_2075086945112
            __token = 3720
            __token = 3756
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 4342
            __content_2075086945112_4340 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_4340 = __quote(__content_2075086945112_4340, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ',\n                                                      (\n                                                      nearby_tile_class(0, -1) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(0, 1) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(-1, 0) == TILE_CLASS_ROAD ? 1 :\n                                                      (nearby_tile_class(1, 0) == TILE_CLASS_ROAD ? 1 : 0\n                                                      ))))) {\n        1: ', (__content_2075086945112_4340 if (__content_2075086945112_4340 is not None) else ''), ';\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_require_houses_nearby(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point}, nearby_tile_class(${location_check.x}, ${location_check.y})) {\n        ' (93:86)> braces_required=True translation=False at 1e3258da550> -> __content_2075086945112
            __token = 4620
            __token = 4656
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 4712
            __content_2075086945112_4710 = _lookup_attr(getitem('location_check'), 'x')
            __content_2075086945112_4710 = __quote(__content_2075086945112_4710, '\x00', '&#0;', None, False)
            __token = 4733
            __content_2075086945112_4731 = _lookup_attr(getitem('location_check'), 'y')
            __content_2075086945112_4731 = __quote(__content_2075086945112_4731, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ', nearby_tile_class(', (__content_2075086945112_4710 if (__content_2075086945112_4710 is not None) else ''), ', ', (__content_2075086945112_4731 if (__content_2075086945112_4731 is not None) else ''), ')) {\n        ', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
            ...
            # <Interpolation value=<Substitution '\n        TILE_CLASS_HOUSE: return CB_RESULT_LOCATION_ALLOW;\n        ${location_check.switch_result};\n    }\n' (95:187)> braces_required=True translation=False at 1e3258daa90> -> __content_2075086945112
            __token = 4951
            __token = 5012
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
    ...
    def render_allow_player(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, PARENT, ${location_check.switch_entry_point}, (\n                (((extra_callback_info2 & 0xFF00) >> 8) == IND_CREATION_FUND) ||\n                (((extra_callback_info2 & 0xFF00) >> 8) == IND_CREATION_PROSPECT)\n                )\n            ) {\n        1: return CB_RESULT_LOCATION_ALLOW;\n        ${location_check.switch_result};\n    }\n' (107:7)> braces_required=True translation=False at 1e324a3e390> -> __content_2075086945112
            __token = 5403
            __token = 5441
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 5730
            __content_2075086945112_5728 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_5728 = __quote(__content_2075086945112_5728, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, PARENT, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ', (\n                (((extra_callback_info2 & 0xFF00) >> 8) == IND_CREATION_FUND) ||\n                (((extra_callback_info2 & 0xFF00) >> 8) == IND_CREATION_PROSPECT)\n                )\n            ) {\n        1: return CB_RESULT_LOCATION_ALLOW;\n        ', (__content_2075086945112_5728 if (__content_2075086945112_5728 is not None) else ''), ';\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_disallow_industry_adjacent(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point},\n        (nearby_tile_class( 1,  1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 1,  0) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 1, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 0, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1,  0) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1,  1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 0,  1) == TILE_CLASS_INDUSTRY)) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ${location_check.switch_result};\n    }\n' (124:7)> braces_required=True translation=False at 1e3258b8780> -> __content_2075086945112
            __token = 6148
            __token = 6183
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 6765
            __content_2075086945112_6763 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_6763 = __quote(__content_2075086945112_6763, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ',\n        (nearby_tile_class( 1,  1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 1,  0) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 1, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 0, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1, -1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1,  0) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class(-1,  1) == TILE_CLASS_INDUSTRY) |\n        (nearby_tile_class( 0,  1) == TILE_CLASS_INDUSTRY)) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ', (__content_2075086945112_6763 if (__content_2075086945112_6763 is not None) else ''), ';\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_disallow_desert(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch(FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point},\n                (nearby_tile_terrain_type( 1, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 1,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 1,  1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0,  1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1,  1) == TILETYPE_DESERT)\n            ) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ${location_check.switch_result};\n    }\n' (141:122)> braces_required=True translation=False at 1e3258b8710> -> __content_2075086945112
            __token = 7028
            __token = 7063
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 7826
            __content_2075086945112_7824 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_7824 = __quote(__content_2075086945112_7824, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch(FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ',\n                (nearby_tile_terrain_type( 1, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 1,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 1,  1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type( 0,  1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1, -1) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1,  0) == TILETYPE_DESERT) &&\n                (nearby_tile_terrain_type(-1,  1) == TILETYPE_DESERT)\n            ) {\n        1: return CB_RESULT_LOCATION_DISALLOW;\n        ', (__content_2075086945112_7824 if (__content_2075086945112_7824 is not None) else ''), ';\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
    ...
    def render_require_effectively_flat(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '\n    switch (FEAT_INDUSTRYTILES, SELF, ${location_check.switch_entry_point},\n                (\n                nearby_tile_height(-relative_x, -relative_y)\n                + (nearby_tile_slope(-relative_x, -relative_y)\n                == SLOPE_FLAT ? 0 :\n                nearby_tile_slope(-relative_x, -relative_y) == bitmask(IS_STEEP_SLOPE) ? 2 : 1\n                )) == (nearby_tile_height(0, 0)\n                + (nearby_tile_slope(0, 0)\n                == SLOPE_FLAT ? 0 :\n                nearby_tile_slope(0, 0) == bitmask(IS_STEEP_SLOPE) ? 2 : 1))\n                ) {\n        1: ${location_check.switch_result};\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n' (167:7)> braces_required=True translation=False at 1e3258b80f0> -> __content_2075086945112
            __token = 8422
            __token = 8458
            __content_2075086945112 = _lookup_attr(getitem('location_check'), 'switch_entry_point')
            __content_2075086945112 = __quote(__content_2075086945112, '\x00', '&#0;', None, False)
            __token = 9004
            __content_2075086945112_9002 = _lookup_attr(getitem('location_check'), 'switch_result')
            __content_2075086945112_9002 = __quote(__content_2075086945112_9002, '\x00', '&#0;', None, False)
            __content_2075086945112 = ('%s%s%s%s%s' % ('\n    switch (FEAT_INDUSTRYTILES, SELF, ', (__content_2075086945112 if (__content_2075086945112 is not None) else ''), ',\n                (\n                nearby_tile_height(-relative_x, -relative_y)\n                + (nearby_tile_slope(-relative_x, -relative_y)\n                == SLOPE_FLAT ? 0 :\n                nearby_tile_slope(-relative_x, -relative_y) == bitmask(IS_STEEP_SLOPE) ? 2 : 1\n                )) == (nearby_tile_height(0, 0)\n                + (nearby_tile_slope(0, 0)\n                == SLOPE_FLAT ? 0 :\n                nearby_tile_slope(0, 0) == bitmask(IS_STEEP_SLOPE) ? 2 : 1))\n                ) {\n        1: ', (__content_2075086945112_9002 if (__content_2075086945112_9002 is not None) else ''), ';\n        return CB_RESULT_LOCATION_DISALLOW;\n    }\n', ))
            if (__content_2075086945112 is None):
                pass
            else:
                if (__content_2075086945112 is False):
